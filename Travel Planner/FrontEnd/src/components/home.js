    ...
    render() {
        ...
        return (
            <div>
                        ...
                        <div className="mx-auto text-center">
                            ...
                            <div className="form-inline d-flex">
                                <input
                                    ...
                                    placeholder="Where?"
                                />&nbsp;
                    <button disabled={!this.state.continent} className="btn btn-info btn-lg mx-auto" onClick={this.getPackages}>Search</button>
                ...
                <section id="signup"type="email" className="signup-section">
                    <div className="container">
                        <div className="row">
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50">Northeastern University, Boston</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50">customersupport@wanderlust.com</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="col-md-4 mb-3 mb-md-0">
                                <div className="card py-4 h-100">
                                    <div className="card-body text-center">
                                        ...
                                        <hr className="my-4" />
                                        <div className="small text-black-50">+12034407456</div>
                                    </div>
                                </div>
                            </div>
                        </div>
