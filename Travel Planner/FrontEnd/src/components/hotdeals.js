...
class HotDeals extends Component {
    ...
    componentDidMount() {
        ...
        this.setState({userId:userId, show: true}, () => this.getHotDeals());
        // this.getHotDeals();
    }
    ...
    getHotDeals = () => {
        axios.get(backendUrlPackage+'/hotDeals')
            .then(response => {
                ...
                this.setState({ errorMessage: error.response.data.message, hotDeals: null, show: false })
            })
    }
    ...
    displayHotDeals = () => {
        ...
        for (let hotDeal of this.state.hotDeals) {
            let element = (
                <div className="card bg-light text-dark package-card mt-5" key={hotDeal.destinationId} >
                    <div className="row card-body" >
                        ...
                        <div className="col-md-3">
                            ...
                            <p className='text-center text-success h5'>${hotDeal.chargesPerPerson}.00</p><br/>
                            <div><button id="hdViewDetails" className="btn btn-info btn-block btn-lg mx-auto book" onClick={() => this.getitinerary(hotDeal)}><small>View Details</small></button></div><br />
