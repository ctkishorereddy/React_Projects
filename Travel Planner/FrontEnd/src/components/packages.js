...
class Packages extends Component {
    ...
    getPackages = (continent) => {
        axios.get(backendUrlPackage + '/destinations/' + continent)
            .then((response) => {
                ...
                console.log(error)
                this.setState({ errorMessage: error.response.data.message, packages: [], show: false })
            })
    }
    ...
    componentDidMount() {
        ...
        this.setState({userId:userId, show: true}, () => this.getPackages(continent) )
                    ...
                    <div className="card bg-light text-dark package-card mt-5" key={mypackage.destinationId}>
                        <div className="card-body row">
                            ...
                            <div className="col-md-3">
                                ...
                                <div className="text-center text-success "><h5>${mypackage.chargesPerPerson}.00</h5></div><br /><br />
                                <div><button id="packViewDetails" className="btn btn-info btn-block btn-lg mx-auto book" onClick={() => this.getitinerary(mypackage)}><small>View Details</small></button></div><br />
